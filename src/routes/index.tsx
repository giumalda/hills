          ...
          <div className="reveal relative flex items-center justify-center md:col-span-5">
            <div className="relative flex w-full max-w-sm items-center justify-center py-6 sm:max-w-md">
              <img
                ...
                alt=""
                aria-hidden="true"
                className="pointer-events-none absolute -left-4 top-2 z-0 w-24 -rotate-12 drop-shadow-xl sm:w-32 md:-left-8 md:top-0 md:w-44"
              />
              <img
                src={cola}
                alt=""
                aria-hidden="true"
                className="pointer-events-none absolute -right-4 bottom-4 z-0 w-20 rotate-12 drop-shadow-xl sm:w-28 md:-right-6 md:bottom-2 md:w-36"
              />
              <img
                src={heroBurger}
