...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Hill's Burger & Chips: panini, combo e special burger in stile Springfield a Mottola (TA).",
      },
      { name: "author", content: "Hill's Burger & Chips" },
      { property: "og:title", content: "Hill's Burger & Chips | Mottola (TA)" },
      {
        property: "og:description",
        content: "Panini, combo e special burger in stile Springfield a Mottola (TA).",
      },
